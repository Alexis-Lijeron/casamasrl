...
<body class="bg-light">
    <div class="container mt-5">
        ...
        @endif
        <form action="{{ route('report.sendReport') }}" method="POST" enctype="multipart/form-data" class="p-4 shadow-sm bg-white rounded">
            @csrf
            <div class="mb-3">
                <label for="to" class="form-label">Destinatarios:</label>
                <input type="text" name="to" id="to" class="form-control" placeholder="Introduzca los emails separados por coma">
