<x-layouts.app>
    ...
    <x-layouts.content title="Reportes" subtitle="Reporte de Ventas" name="Reporte de Ventas">
                ...
                <div class="card-box">
                    ...
                    <form method="post" id="formularioReporte">
                        <div class="row">
                            ...
                            <div class="col-md-3 px-1">
                                <div class="form-group">
                                    <label for="id_categoria" class="control-label mb-1 pl-1">
                                        <strong>Elige categoria</strong>
                                    </label>
                                    <select class="form-control text-truncate" data-toggle="select2" id="id_categoria"
                                        name="id_categoria">
                                        <option value="0">Todos</option>
                                        @foreach ($categorias as $categoria)
                                        <option value="{{ $categoria['id'] }}"
                                        @if ($categoria['id'] == old('id_categoria')) selected @endif>{{
    ...
    @push('js')
        ...
        <script>
            $(document).ready(function() {
                        ...
                        .then(data => {
                            ...
                            // Iterar sobre los datos y agregarlos a la tabla
                                cotizaciones.forEach(cotizacion => {
                                    ...
                                    row += '<td class="align-middle">' + cotizacion.vehiculo.categoria.nombre + '</td>';
                ...
                function generarPDF() {
                    ...
                    const url = `/dashboard/generar-reporte-cotizaciones/pdf/${admin}/${cliente}/${categoria}/${modelo}/${modelo}/${servicio}/${producto}/${f1}/${f2}`;
        ...
        <script>
            function validarDatos() {
                ...
                if (!fechaDesde.val() && !fechaHasta.val() && !administrativo.val() && !cliente.val() && !categoria.val() && !modelo.val() && !tipoVehiculo.val() && !servicio.val() && !producto.val()) {
                    ...
                    $("#mensajeMarca").text("El campo categoria es requerido.");
