<x-layouts.app>
    ...
    <x-layouts.content title="Ajuste Inventario" subtitle="Registrar Ajuste Inventario" name="Ajuste Inventario">
        ...
        <div class="row mb-5">
            <div class="col-12">
                <div class="card-box">
                    ...
                    <form class="px-4 pt-2 pb-2" action="{{ route('ajustes.store') }}" method="POST">
                        @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Recuperar los productos de la sesión (si existen)
            const productosSession = @json(session('productos') ? json_decode(session('productos'), true) : []);
