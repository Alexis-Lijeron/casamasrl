<x-layouts.app>
    ...
    <x-layouts.content title="Proveedores" subtitle="" name="Proveedores">
                        ...
                        <table id="table-proveedor" class="table table-hover mb-0 dts">
                            ...
                            <tbody>
                                ...
                                <tr class="text-nowrap text-center">
                                    ...
                                    <td class="align-middle">{{ $proveedor['nombre_empresa'] }}</td>
                                    <td class="align-middle">{{ $proveedor['nombre_encargado'] }}</td>
